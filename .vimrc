...
" Plugins: {
    ...
    " Syntaxes: {
        ...
        Plugin 'hashivim/vim-terraform' " Basic terraform syntax highlightning"
    "}
" }
...
" Autocompletions: { Basically, Vim's built-in auto-completions support with uniform keyboard shortcuts.
    ...
    set completeopt+=longest,menuone " Attempts to insert longest obviously current common match found so far.
